...
int main(int argc,char **argv)
{
	...
	for(int i=0;i<10;i++)
	{
		cout<<count_call1(c_cnt)<<endl;//可以用引用改变数值
		cout<<count_call()<<endl;//static 静态对象可以保留局部对象
	}
	cout<<endl<<endl;
	...
	cout<<find_char(s,'i',cnt)<<endl;//
	cout<<cnt<<endl;
	cnt=0;
	cout<<find_char("lilipeipei",'i',cnt)<<endl;//"lilipeipei" 是const string 类型,
